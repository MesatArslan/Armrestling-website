...
const DoubleElimination33_47: React.FC<DoubleElimination33_47Props> = ({ players, resetKey, onMatchResult, onTournamentComplete, onUpdateOpponents, onRemoveOpponents, onClearAllOpponents, fixtureId }) => {
  ...
  const undoLastMatch = () => {
    ...
    if (lastId === 'grandfinal') {
      ...
      if (gf && !gf.winnerId) removeIds(['grandfinal']);
          ...
          delete updatedRankings.second;
      newTournamentComplete = false;
      // Final geri alındığında placement 5-6 turuna dön
      ...
      // 7-8 placement geri alımı: sadece bu maçın kazananını temizle, skorları sil
      ...
      // 5-6 placement geri alımı: sadece bu maçın kazananını temizle, skorları sil
      ...
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'fifth_sixth', ...lb8Ids];
      removeIds(idsToRemove);
      delete updatedRankings.fourth;
      delete updatedRankings.third;
      delete updatedRankings.fifth;
      ...
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      // WB5 (Quarter) maçlarını KALDIRMA; sadece sonraki turları temizle
      const idsToRemove = ['yarifinal', 'lbfinal', 'final', 'grandfinal', 'fifth_sixth', ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      delete updatedRankings.first;
      delete updatedRankings.second;
      delete updatedRankings.third;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
          delete updatedRankings.seventh;
          delete updatedRankings.eighth;
          delete updatedRankings.fifth;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['yarifinal', 'lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...wb5Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb5Ids = updatedMatches.filter(m => m.id.startsWith('lb5_')).map(m => m.id);
      const lb6Ids = updatedMatches.filter(m => m.id.startsWith('lb6_')).map(m => m.id);
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...lb5Ids, ...lb6Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['yarifinal', 'lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...wb4Ids, ...wb5Ids, ...lb3Ids, ...lb4Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...lb4Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...lb3Ids, ...lb4Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...lb2Ids, ...lb3Ids, ...lb4Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['yarifinal', 'lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...wb3Ids, ...wb4Ids, ...wb5Ids, ...lb1Ids, ...lb2Ids, ...lb3Ids, ...lb4Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
      ...
      const lb7Ids = updatedMatches.filter(m => m.id.startsWith('lb7_')).map(m => m.id);
      const lb8Ids = updatedMatches.filter(m => m.id.startsWith('lb8_')).map(m => m.id);
      const idsToRemove = ['yarifinal', 'lbfinal', 'final', 'grandfinal', 'seventh_eighth', 'fifth_sixth', ...wb2Ids, ...wb3Ids, ...wb4Ids, ...wb5Ids, ...lb1Ids, ...lb2Ids, ...lb3Ids, ...lb4Ids, ...lb5Ids, ...lb6Ids, ...lb7Ids, ...lb8Ids];
      removeIds(idsToRemove);
      updatedRankings = {} as Ranking;
