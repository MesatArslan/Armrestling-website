...
const DoubleElimination192_256: React.FC<DoubleElimination192_256Props> = ({ players, resetKey, onMatchResult, onTournamentComplete, initialTab, fixtureId }) => {
        ...
        for (let i = 0; i < wb6Winners.length; i += 2) {
          if (i + 1 < wb6Winners.length) {
            wb7Matches.push({
              ...
              matchNumber: Math.floor(i/2) + 1,
              isBye: false,
              description: `WB Round 7 (Quarterfinals) - Match ${Math.floor(i/2) + 1}`
            });
          }
        }
        return wb7Matches;
