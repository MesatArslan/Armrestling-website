...
const DoubleElimination96_128: React.FC<DoubleElimination96_128Props> = ({ players, resetKey, onMatchResult, onTournamentComplete, onUpdateOpponents, onRemoveOpponents, fixtureId }) => {
