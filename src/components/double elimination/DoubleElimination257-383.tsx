...
const DoubleElimination257_383: React.FC<DoubleElimination257_383Props> = ({ players, resetKey, onMatchResult, onTournamentComplete, onUpdateOpponents, onRemoveOpponents, onClearAllOpponents, fixtureId }) => {
  ...
  // Auto-select control (same logic as 192-256)
    ...
    switch (nextRoundKey) {
      ...
      case 'WB7': {
        ...
        return wb7Matches;
          ...
          const pairs = pairAvoidingRematch(lb11Players);
          pairs.forEach(([p1, p2], idx) => {
            lb11Matches.push({
              id: `lb11_${idx + 1}`,
              player1Id: p1,
          ...
          const pairs = pairAvoidingRematch(lb11Winners);
          pairs.forEach(([p1, p2], idx) => {
            lb12Matches.push({
              id: `lb12_${idx + 1}`,
              player1Id: p1,
      ...
      case 'WB8': {
        ...
        return wb8Matches;
          ...
          const pairs = pairAvoidingRematch(lb13Players);
          pairs.forEach(([p1, p2], idx) => {
            lb13Matches.push({
              id: `lb13_${idx + 1}`,
              player1Id: p1,
      ...
      case 'YariFinal': {
        ...
        return yariFinalMatches;
          ...
          const pairs = pairAvoidingRematch(lb13Winners);
          pairs.forEach(([p1, p2], idx) => {
            lb14Matches.push({
              id: `lb14_${idx + 1}`,
              player1Id: p1,
  ...
  const undoLastMatch = () => {
    ...
    if (lastId === 'grandfinal') {
      ...
      newCurrentRoundKey = '5-6';
    } else if (lastId === 'lb14_1') {
      clearWinner('lb14_1');
      delete updatedRankings.fourth;
      newCurrentRoundKey = 'LB14';
    } else {
