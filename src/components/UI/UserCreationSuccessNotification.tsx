...
interface UserCreationSuccessNotificationProps {
  isOpen: boolean
  onClose: () => void
  message: string
  duration?: number
...
const UserCreationSuccessNotification: React.FC<UserCreationSuccessNotificationProps> = ({
  isOpen,
  onClose,
  message,
  duration = 4000
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2">
              <div className="w-full bg-gray-200 rounded-full h-1">
                <div 
                  className="bg-gradient-to-r from-green-500 to-green-600 h-1 rounded-full transition-all duration-100 ease-linear animate-progress"
                  style={{
...
export default UserCreationSuccessNotification
