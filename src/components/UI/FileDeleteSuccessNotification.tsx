...
interface FileDeleteSuccessNotificationProps {
  isOpen: boolean
  onClose: () => void
  message: string
  duration?: number
...
const FileDeleteSuccessNotification: React.FC<FileDeleteSuccessNotificationProps> = ({
  isOpen,
  onClose,
  message,
  duration = 4000
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-semibold text-gray-900">{t('notifications.deleted')}</h4>
              <button
                onClick={onClose}
            ...
            <div className="mt-2">
              <div className="w-full bg-gray-200 rounded-full h-1">
                <div 
                  className="bg-gradient-to-r from-red-500 to-red-600 h-1 rounded-full transition-all duration-100 ease-linear"
                  style={{
...
export default FileDeleteSuccessNotification
