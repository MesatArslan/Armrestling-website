...
const Hero = () => {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-brand-bg bg-brand-radial w-screen flex items-center" style={{ height: 'calc(100vh - 64px)' }}>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8">
            <FireIcon className="w-4 h-4 text-brand-text" />
            <span className="text-sm font-semibold text-brand-text">{t('home.badge', { defaultValue: 'Professional Tournament Management' })}</span>
          </div>
          ...
          <p className="text-xl sm:text-2xl text-brand-text max-w-4xl mx-auto mb-12 leading-relaxed animate-fade-in-up delay-200">
            {t('home.description')}
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-16">
            <Link 
              to="/tournaments" 
              className="group inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-brand-primaryDark text-white font-bold text-lg hover:bg-brand-primary transition-colors shadow-brand-xl"
            >
            ...
            <Link 
              to="/players" 
              className="group inline-flex items-center gap-3 px-8 py-4 rounded-2xl text-white font-bold text-lg ring-1 ring-brand-primary/30 hover:bg-white/10 transition-colors"
            >
          ...
          {/* Trust indicators */}
          <div className="flex flex-wrap justify-center items-center gap-8 text-brand-text">
            <div className="flex items-center gap-2">
              <ShieldCheckIcon className="w-5 h-5 text-brand-text" />
              <span className="text-sm font-medium">{t('home.trust.secure', { defaultValue: 'Secure & Reliable' })}</span>
            </div>
            <div className="flex items-center gap-2">
              <GlobeAltIcon className="w-5 h-5 text-brand-text" />
              <span className="text-sm font-medium">{t('home.trust.multilingual', { defaultValue: 'Multilingual Support' })}</span>
            </div>
            <div className="flex items-center gap-2">
              <DevicePhoneMobileIcon className="w-5 h-5 text-brand-text" />
...
const Features = () => {
  ...
  return (
    <section className="relative w-screen py-20">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-brand-primary/20 to-brand-accent/20 border border-brand-primary/30 mb-6">
              <LightBulbIcon className="w-4 h-4 text-brand-text" />
              <span className="text-sm font-semibold text-brand-text">{t('home.features.badge', { defaultValue: 'Platform Features' })}</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className={`group relative rounded-3xl p-8 ${feature.bgColor} border ${feature.borderColor} hover:shadow-brand-xl transition-all duration-300 hover:-translate-y-2`}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-white mb-3 group-hover:text-brand-text transition-colors">
                      {feature.title}
                    </h3>
    ...
    <section className="relative w-screen py-20">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-brand-primary/20 to-brand-accent/20 border border-brand-primary/30 mb-6">
              <CheckBadgeIcon className="w-4 h-4 text-brand-text" />
              <span className="text-sm font-semibold text-brand-text">{t('home.steps.badge', { defaultValue: 'Simple Process' })}</span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-6">
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                {t('home.steps.title')}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {steps.map(({ Icon, title, desc, details, color, bgColor, borderColor }, idx) => (
              <div 
                key={idx}
                className={`group relative rounded-3xl p-8 ${bgColor} border ${borderColor} hover:shadow-brand-xl transition-all duration-300 hover:-translate-y-2`}
              >
                {/* Step Number */}
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-brand-text transition-colors">
                      {title}
                    </h3>
                    <p className="text-lg text-brand-text mb-4 font-medium">
                      {desc}
                    </p>
                    <p className="text-brand-text leading-relaxed">
                      {details}
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-brand-primary to-brand-accent text-white font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
...
const BottomCTA = () => {
  const { t } = useTranslation();
  return (
    <section className="relative w-screen py-16">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h3 className="text-3xl sm:text-4xl font-extrabold tracking-tight">{t('home.bottomCta.title')}</h3>
          <p className="mt-3 text-lg text-brand-text">{t('home.bottomCta.description')}</p>
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Link to="/tournaments" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-primaryDark text-white font-semibold hover:bg-brand-primary transition shadow-brand-xl">
              <TrophyIcon className="w-5 h-5" />
              <span>{t('home.bottomCta.primary')}</span>
            </Link>
            <Link to="/players" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/10 ring-1 ring-brand-primary/40 text-white font-semibold backdrop-blur hover:bg-white/20 transition">
...
const Footer = () => {
  ...
  return (
    <footer className="relative w-screen text-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-brand-text mb-6 max-w-md leading-relaxed">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 text-sm text-brand-text">
                  <ShieldCheckIcon className="w-4 h-4 text-brand-text" />
                  <span>{t('home.footer.secure', { defaultValue: 'Secure Platform' })}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-brand-text">
                  <GlobeAltIcon className="w-4 h-4 text-brand-text" />
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/tournaments" className="text-brand-text hover:text-brand-primary transition-colors">
                    {t('navigation.tournaments')}
                  </Link>
                </li>
                <li>
                  <Link to="/players" className="text-brand-text hover:text-brand-primary transition-colors">
                    {t('navigation.players')}
                  </Link>
                </li>
                <li>
                  <Link to="/matches" className="text-brand-text hover:text-brand-primary transition-colors">
                    {t('navigation.matches')}
                  </Link>
                </li>
                <li>
                  <Link to="/scoring" className="text-brand-text hover:text-brand-primary transition-colors">
          ...
          <div className="border-t border-white/10 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-6 text-sm text-brand-text">
                <span>{t('home.footer.version', { defaultValue: 'Version 1.0' })}</span>
                <span>•</span>
                <span>{t('home.footer.madeWith', { defaultValue: 'Made with' })}</span>
                <span className="font-bold bg-gradient-to-r from-brand-primary via-brand-primary to-brand-accent bg-clip-text text-transparent animate-pulse">
                  M.E.A.
                </span>
              </div>
            </div>
...
const Home = () => {
  return (
    <div className="relative w-screen bg-brand-bg bg-brand-radial">
      <Hero />
      <Features />
      <Steps />
      <BottomCTA />
