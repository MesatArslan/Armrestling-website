        ...
        <div className="backdrop-blur-md bg-white/80 rounded-2xl border border-gray-200 shadow-2xl p-6 transition-all duration-300">
          ...
          {fixtures.length > 0 && (
            <div className="mb-8">
              ...
              {/* Mobile: horizontal scroll fixtures */}
                    ...
                    <div key={fixture.id} className="shrink-0 w-72 snap-start">
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute top-3 right-3 p-2 rounded-full bg-white/80 backdrop-blur-sm border border-gray-200 text-gray-400 hover:text-red-500 hover:bg-red-50 hover:border-red-200 transition-all duration-200 opacity-100"
