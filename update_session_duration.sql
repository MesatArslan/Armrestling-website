-- Session süresini 5 saate değiştir
-- Bu kod sadece mevcut session süresini günceller

-- 1. Mevcut session'ların süresini güncelle (5 saat)
...
BEGIN
    ...
    v_expires_at := NOW() + INTERVAL '5 hours';  -- 5 saat
...
-- 4. Kontrol sorguları
SELECT 'Session süresi 5 saate güncellendi!' as status;
