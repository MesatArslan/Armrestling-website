-- Dosya Yönetimi Tablosu (100 Kurum İçin Optimize Edilmiş)
...
-- Optimize Edilmiş Index'ler (100 Kurum İçin)
...
-- Download log için optimize edilmiş index'ler
...
-- İzinleri ayarla (RLS devre dışı olsa da gerekli)
...
-- Sequence izinleri (UUID için)
GRANT USAGE ON SCHEMA public TO authenticated;

-- Dosya yönetimi için gerekli tüm tablolar oluşturuldu
-- 100 kurum için optimize edilmiş versiyon
